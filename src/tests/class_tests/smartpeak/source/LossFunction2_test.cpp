...
#define BOOST_TEST_MODULE LossFunction2 test suite 
...
BOOST_AUTO_TEST_SUITE(lossFunction2)
//
///**
...
BOOST_AUTO_TEST_CASE(operationfunctionMSEOp1) 
{
  ...
  operation(y_pred.data(), y_true.data(), error_ptr, batch_size, memory_size, 0, 2, 0, device);
