...
BOOST_AUTO_TEST_CASE(ReadMNIST)
{
  ...
  std::string training_data_filename = EVONET_GET_TEST_DATA_PATH("train-images.idx3-ubyte");
  std::string training_labels_filename = EVONET_GET_TEST_DATA_PATH("train-labels.idx1-ubyte");
...
BOOST_AUTO_TEST_CASE(readData)
{
  ...
  std::string training_data_filename = EVONET_GET_TEST_DATA_PATH("train-images.idx3-ubyte");
  std::string training_labels_filename = EVONET_GET_TEST_DATA_PATH("train-labels.idx1-ubyte");
  std::string validation_data_filename = EVONET_GET_TEST_DATA_PATH("t10k-images.idx3-ubyte");
  std::string validation_labels_filename = EVONET_GET_TEST_DATA_PATH("t10k-labels.idx1-ubyte");
