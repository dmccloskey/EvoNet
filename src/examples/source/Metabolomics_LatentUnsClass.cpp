...
void main_(const ParameterTypes& ...args) {
  ...
  makeModelTrainer<float>(model_trainer, std::vector<std::string>(), encoding_nodes_mu, encoding_nodes_logvar, std::vector<std::string>(), encoding_nodes_logalpha, args...);
...
int main(int argc, char** argv)
{
  ...
  EvoNetParameters::ModelTrainer::LoggingValidation logging_validation("logging_validation", true);
