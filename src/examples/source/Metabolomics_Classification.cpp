...
void main_(const ParameterTypes& ...args) {
  ...
  MetabolomicsClassificationDataSimulator<float> data_simulator;
  ...
  makeModelTrainer<float>(model_trainer, std::vector<std::string>(), std::vector<std::string>(), std::vector<std::string>(), std::vector<std::string>(), encoding_nodes_alpha, args...);
