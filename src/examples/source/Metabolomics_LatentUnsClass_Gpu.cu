...
void main_(const ParameterTypes& ...args) {
  ...
  makeModelTrainer<float>(model_trainer, std::vector<std::string>(), encoding_nodes_mu, encoding_nodes_logvar, std::vector<std::string>(), categorical_softmax_nodes, args...);
