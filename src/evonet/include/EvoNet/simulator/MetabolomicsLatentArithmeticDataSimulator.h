...
#ifndef EVONET_METABOLOMICSLATENTARITHMETICDATASIMULATOR_H
#define EVONET_METABOLOMICSLATENTARITHMETICDATASIMULATOR_H
...
namespace EvoNet
{
  ...
  class MetabolomicsLatentArithmeticDataSimulator : public BiochemicalDataSimulator<TensorT>
  {
  public:
    ...
    int & n_reps_per_sample, const bool& randomize_sample_group_names, const bool& shuffle_data_and_labels, const int & n_epochs, const int & batch_size, const int & memory_size)
  {
    ...
    if (use_concentrations) {
      ...
      this->makeTrainingDataForCache(features_training, data_training, labels_training, n_epochs, batch_size, memory_size,
        2*n_component_group_names_training, n_component_group_names_training, n_component_group_names_training, shuffle_data_and_labels);
      ...
      // Make the training data cache
      this->makeTrainingDataForCache(features_training, data_training, labels_training, n_epochs, batch_size, memory_size,
        2*n_reaction_ids_validation, n_reaction_ids_validation, n_reaction_ids_validation, shuffle_data_and_labels);
      this->makeValidationDataForCache(features_validation, data_validation, labels_validation, n_epochs, batch_size, memory_size,
        2*n_reaction_ids_validation, n_reaction_ids_validation, n_reaction_ids_validation, shuffle_data_and_labels);
    }
  }
...
#endif //EVONET_METABOLOMICSLATENTARITHMETICDATASIMULATOR_H