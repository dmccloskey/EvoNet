...
#ifndef EVONET_MODELINTERPRETERDEFAULTDEVICE_H
#define EVONET_MODELINTERPRETERDEFAULTDEVICE_H

#define EIGEN_USE_THREADS

// .h
#include <EvoNet/ml/ModelInterpreter.h>
...
#include <EvoNet/ml/ModelKernal.h>
...
CEREAL_REGISTER_TYPE(EvoNet::ModelInterpreterDefaultDevice<float>);
// TODO: add double, int, etc.

#endif //EVONET_MODELINTERPRETERDEFAULTDEVICE_H