...
#ifndef EVONET_MODELINTERPRETERGPU_H
#define EVONET_MODELINTERPRETERGPU_H
...
CEREAL_REGISTER_TYPE(EvoNet::ModelInterpreterGpu<float>);
// TODO: add double, int, etc.

#endif
#endif //EVONET_MODELINTERPRETERGPU_H