...
#ifndef EVONET_MODELINTERPRETER_H
#define EVONET_MODELINTERPRETER_H
...
#include <EvoNet/ml/OpToTensorOp.h>
#include <EvoNet/ml/ModelResources.h>
...
#endif //EVONET_MODELINTERPRETER_H