...
#ifndef EVONET_MODELERRORDATA_H
#define EVONET_MODELERRORDATA_H
...
//CEREAL_REGISTER_TYPE(EvoNet::ModelErrorDataCpu<float>);
//// TODO: add double, int, etc.
//#if COMPILE_WITH_CUDA
//CEREAL_REGISTER_TYPE(EvoNet::ModelErrorDataGpu<float>);
//// TODO: add double, int, etc.
//#endif

#endif //EVONET_MODELERRORDATA_H