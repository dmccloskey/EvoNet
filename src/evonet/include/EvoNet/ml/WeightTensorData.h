...
#ifndef EVONET_WEIGHTTENSORDATA_H
#define EVONET_WEIGHTTENSORDATA_H
...
//CEREAL_REGISTER_TYPE(EvoNet::WeightTensorDataCpu<float>);
//// TODO: add double, int, etc.
//#if COMPILE_WITH_CUDA
//CEREAL_REGISTER_TYPE(EvoNet::WeightTensorDataGpu<float>);
//// TODO: add double, int, etc.
//#endif

#endif //EVONET_WEIGHTTENSORDATA_H