...
#ifndef EVONET_WEIGHTINIT_H
#define EVONET_WEIGHTINIT_H
...
CEREAL_REGISTER_TYPE(EvoNet::RandWeightInitOp<float>);
CEREAL_REGISTER_TYPE(EvoNet::ConstWeightInitOp<float>);
CEREAL_REGISTER_TYPE(EvoNet::RangeWeightInitOp<float>);
//CEREAL_REGISTER_TYPE(EvoNet::RandWeightInitOp<double>);
//CEREAL_REGISTER_TYPE(EvoNet::ConstWeightInitOp<double>);
//CEREAL_REGISTER_TYPE(EvoNet::RangeWeightInitOp<double>);
//CEREAL_REGISTER_TYPE(EvoNet::RandWeightInitOp<int>);
//CEREAL_REGISTER_TYPE(EvoNet::ConstWeightInitOp<int>);
//CEREAL_REGISTER_TYPE(EvoNet::RangeWeightInitOp<int>);
#endif //EVONET_WEIGHTINIT_H