...
#ifndef EVONET_ACTIVATIONTENSORFUNCTION_H
#define EVONET_ACTIVATIONTENSORFUNCTION_H
...
#include <EvoNet/ml/ActivationFunction.h>
...
//CEREAL_REGISTER_TYPE(EvoNet::ReLUTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::ReLUGradTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::ELUTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::ELUGradTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::SigmoidTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::SigmoidGradTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::TanHTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::TanHGradTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::ReTanHTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::ReTanHGradTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::LinearTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::LinearGradTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::InverseTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::InverseGradTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::ExponentialTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::ExponentialGradTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::LogTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::LogGradTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::PowTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::PowGradTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::LeakyReLUTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::LeakyReLUGradTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::SinTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::SinGradTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::CosTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::CosGradTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::BatchNormTensorOp<float, Eigen::DefaultDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::BatchNormGradTensorOp<float, Eigen::DefaultDevice>);
//
//#if COMPILE_WITH_CUDA
//CEREAL_REGISTER_TYPE(EvoNet::ReLUTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::ReLUGradTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::ELUTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::ELUGradTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::SigmoidTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::SigmoidGradTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::TanHTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::TanHGradTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::ReTanHTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::ReTanHGradTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::LinearTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::LinearGradTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::InverseTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::InverseGradTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::ExponentialTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::ExponentialGradTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::LogTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::LogGradTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::PowTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::PowGradTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::LeakyReLUTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::LeakyReLUGradTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::SinTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::SinGradTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::CosTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::CosGradTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::BatchNormTensorOp<float, Eigen::GpuDevice>);
//CEREAL_REGISTER_TYPE(EvoNet::BatchNormGradTensorOp<float, Eigen::GpuDevice>);
//#endif
//
//// TODO: double, int, etc.,

#endif //EVONET_ACTIVATIONTENSORFUNCTION_H