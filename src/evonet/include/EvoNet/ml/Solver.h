...
#ifndef EVONET_SOLVER_H
#define EVONET_SOLVER_H
...
CEREAL_REGISTER_TYPE(EvoNet::SGDOp<float>);
CEREAL_REGISTER_TYPE(EvoNet::SSDOp<float>);
CEREAL_REGISTER_TYPE(EvoNet::AdamOp<float>);
CEREAL_REGISTER_TYPE(EvoNet::SVAGOp<float>);
CEREAL_REGISTER_TYPE(EvoNet::DummySolverOp<float>);
//CEREAL_REGISTER_TYPE(EvoNet::SGDOp<double>);
//CEREAL_REGISTER_TYPE(EvoNet::SSDOp<double>);
//CEREAL_REGISTER_TYPE(EvoNet::AdamOp<double>);
//CEREAL_REGISTER_TYPE(EvoNet::SVAGOp<double>);
//CEREAL_REGISTER_TYPE(EvoNet::DummySolverOp<double>);
//CEREAL_REGISTER_TYPE(EvoNet::SGDOp<int>);
//CEREAL_REGISTER_TYPE(EvoNet::SSDOp<int>);
//CEREAL_REGISTER_TYPE(EvoNet::AdamOp<int>);
//CEREAL_REGISTER_TYPE(EvoNet::SVAGOp<int>);
//CEREAL_REGISTER_TYPE(EvoNet::DummySolverOp<int>);
#endif //EVONET_SOLVER_H