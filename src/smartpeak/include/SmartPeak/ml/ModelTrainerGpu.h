...
namespace SmartPeak
{
	...
	*/
	...
	template<typename TensorT>
	std::vector<TensorT> ModelTrainerGpu<TensorT>::trainModel(Model<TensorT>& model, const Eigen::Tensor<TensorT, 4>& input, const Eigen::Tensor<TensorT, 4>& output, const Eigen::Tensor<TensorT, 3>& time_steps,
		const std::vector<std::string>& input_nodes,
		ModelLogger<TensorT>& model_logger,
		ModelInterpreterGpu<TensorT>& model_interpreter)
	{
	...
	template<typename TensorT>
	std::vector<TensorT> ModelTrainerGpu<TensorT>::validateModel(Model<TensorT>& model, const Eigen::Tensor<TensorT, 4>& input, const Eigen::Tensor<TensorT, 4>& output, const Eigen::Tensor<TensorT, 3>& time_steps,
		const std::vector<std::string>& input_nodes,
		ModelLogger<TensorT>& model_logger,
		ModelInterpreterGpu<TensorT>& model_interpreter)
	{
	...
	template<typename TensorT>
	std::vector<std::vector<Eigen::Tensor<TensorT, 2>>> ModelTrainerGpu<TensorT>::evaluateModel(Model<TensorT>& model, const Eigen::Tensor<TensorT, 4>& input, const Eigen::Tensor<TensorT, 3>& time_steps, const std::vector<std::string>& input_nodes,
		ModelLogger<TensorT>& model_logger,
		ModelInterpreterGpu<TensorT>& model_interpreter)
	{
