...
private:
	...
	template<typename TensorT>
	inline void Model<TensorT>::expandForwardPropogationOperations(const std::vector<OperationList<TensorT>>& FP_operations, std::vector<OperationList<TensorT>>& FP_operations_expanded)
	{
	...
	template<typename TensorT>
	inline void Model<TensorT>::expandForwardPropogationOperationsBySourceNodeKey(const std::vector<OperationList<TensorT>>& FP_operations, std::vector<OperationList<TensorT>>& FP_operations_expanded)
	{
	...
	template<typename TensorT>
	inline void Model<TensorT>::expandForwardPropogationOperationsByWeightKey(const std::vector<OperationList<TensorT>>& FP_operations, std::vector<OperationList<TensorT>>& FP_operations_expanded)
	{
		FP_operations_expanded.clear();
	...
	template<typename TensorT>
	inline void Model<TensorT>::expandForwardPropogationOperationsByCachedNodes(const std::vector<OperationList<TensorT>>& FP_operations, std::vector<OperationList<TensorT>>& FP_operations_expanded)
	{
		FP_operations_expanded.clear();
	...
	template<typename TensorT>
	inline std::map<std::string, std::vector<int>> Model<TensorT>::getFullyConnectedOperations(const std::vector<OperationList<TensorT>>& FP_operations, std::set<std::string>& identified_sink_nodes)
	{
	...
	template<typename TensorT>
	inline std::map<std::string, std::vector<int>> Model<TensorT>::GetSinglyConnectedOperations(const std::vector<OperationList<TensorT>>& FP_operations, std::set<std::string>& identified_sink_nodes)
	{
	...
	template<typename TensorT>
	inline std::map<std::string, std::vector<int>> Model<TensorT>::getConvOperations(const std::vector<OperationList<TensorT>>& FP_operations, std::set<std::string>& identified_sink_nodes)
	{
	...
	template<typename TensorT>
	inline std::map<std::string, std::vector<int>> Model<TensorT>::getFanOutOperations(const std::vector<OperationList<TensorT>>& FP_operations, std::set<std::string>& identified_sink_nodes)
	{
