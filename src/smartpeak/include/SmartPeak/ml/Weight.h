...
public:
    ...
    Weight(const int& id, std::unique_ptr<WeightInitOp>& weight_init, std::unique_ptr<SolverOp>& solver); ///< Explicit constructor 
    ...
    void setWeightInitOp(std::unique_ptr<WeightInitOp>& weight_init); ///< weight initialization operator setter
    WeightInitOp* getWeightInitOp() const; ///< weight initialization operator getter

    void setSolverOp(std::unique_ptr<SolverOp>& solver); ///< weight update operator setter
...
private:
    ...
    std::unique_ptr<WeightInitOp> weight_init_; ///< weight initialization operator
    std::unique_ptr<SolverOp> solver_; ///< weight update operator
  };
}
