...
public: 
	...
	*/
	...
	public:
      ...
      auto source_weight_1 = (weight_tensor_exp > weight_tensor_exp.constant((TensorT)-1e24) && weight_tensor_exp < weight_tensor_exp.constant((TensorT)1e24)).select(source_weight_exp.constant((TensorT)1), source_weight_exp);
