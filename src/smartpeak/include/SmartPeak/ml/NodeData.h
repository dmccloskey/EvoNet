...
public:
    ...
    { 
      ...
      return *this;
		...
		Eigen::TensorMap<Eigen::Tensor<TensorT, 2>> getInput() { Eigen::TensorMap<Eigen::Tensor<TensorT, 2>> input(h_input_.get(), batch_size_, memory_size_); return input; }; ///< input copy getter
