...
#ifndef SMARTPEAK_METABOLOMICSRECONSTRUCTIONDATASIMULATOR_H
#define SMARTPEAK_METABOLOMICSRECONSTRUCTIONDATASIMULATOR_H
...
#endif //SMARTPEAK_METABOLOMICSRECONSTRUCTIONDATASIMULATOR_H