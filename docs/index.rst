...
This project could have not existed without the excellent tools available: 
Boost, Eigen, Doxygen, Sphinx, and many others.  
...
The full license is
`available here <https://github.com/dmccloskey/EvoNet/blob/develop/LICENSE>`_.